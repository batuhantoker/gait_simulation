...
* Simulation of two leg, inverted and simple pendulum based model
* Simulation of one leg, spring-loaded inverted pendulum model
* Simulation of two leg, spring-loaded inverted pendulum model
